...
- Sync-client bundle: [`planning/changes/archive/2026-06-07.01-sync-client/`](../changes/archive/2026-06-07.01-sync-client/) — design + implementation plan.
- Architecture notes: [`architecture/middleware.md`](../../architecture/middleware.md) (Seam A), [`architecture/overview.md`](../../architecture/overview.md) (module layout).
- Source spec parent (httpx convention): [`planning/changes/archive/2026-06-03.02-thin-httpx2-wrapper/`](../changes/archive/2026-06-03.02-thin-httpx2-wrapper/)
