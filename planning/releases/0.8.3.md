...
**Patch release with three behavioral changes you should know about.** All driven by the [deep audit](../audits/2026-06-07-deep-audit.md); collectively close 7 audit findings (3 RetryBudget, 2 retry-surface nits, 2 chunk-3 test rewrites).
...
7 of the 35 audit findings from [`planning/audits/2026-06-07-deep-audit.md`](../audits/2026-06-07-deep-audit.md) — the entire RetryBudget cross-cutting cluster plus 2 adjacent retry-surface nits.
