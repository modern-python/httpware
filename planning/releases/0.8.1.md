...
- Docs: `docs/errors.md` (hierarchy + new section), `architecture/decoders.md` (Seam B contract) + `architecture/errors.md` (§4 paragraph), `README.md` (one-line note on the `response_model=` paragraph).

## See also

- [`planning/changes/2026-06-07.02-decoder-error.md`](../changes/2026-06-07.02-decoder-error.md) — design rationale + implementation plan.
