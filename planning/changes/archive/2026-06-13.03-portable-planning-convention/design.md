...
`changes/archive/2026-06-13.02-circuit-breaker-and-timeout/design.md`. This is
...
- **`changes/archive/`** — all 17 flat `specs/`+`plans/` pairs and the ~21
...
- Grep gates:
  ...
  - No tracked file outside `planning/changes/archive/` references
